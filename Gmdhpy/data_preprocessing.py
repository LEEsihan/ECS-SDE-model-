...
def split_dataset(data_x, data_y,cost_mat, seq_type):
    ...
    train_cost_mat = cost_mat[idx_train]
    ...
    validate_cost_mat = cost_mat[idx_validate]

    return input_train_x, train_y, input_validate_x, validate_y,train_cost_mat,validate_cost_mat
